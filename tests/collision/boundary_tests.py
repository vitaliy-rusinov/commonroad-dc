...
def scenario_time(path, id):
    ...
    road_boundary_aa_triangulation = boundary.create_road_boundary_obstacle(scenario, method="aligned_triangulation",
                                                                            return_scenario_obstacle=False)
    road_boundary_rectangles = boundary.create_road_boundary_obstacle(scenario, method="obb_rectangles",
                                                                      return_scenario_obstacle=False)
    ...
    road_boundary_triangulation = boundary.create_road_boundary_obstacle(scenario, method="triangulation",
                                                                         return_scenario_obstacle=False)
...
if __name__ == '__main__':
    ...
    dirname = "/home/user/Documents/commonroad/commonroad-scenarios/scenarios"
